...
class Entity(SubmodelElement, base.UniqueIdShortNamespace):
    ...
    *Constraint AASd-014:* global_asset_id or specific_asset_id must be set if :attr:`~.entity_type` is set to
    ...
    def __init__(self,
        ...
        self.specific_asset_id: Optional[
            Set[base.SpecificAssetId]] = set() if specific_asset_id is None else specific_asset_id
    ...
    def _validate_asset_ids_for_entity_type(entity_type: base.EntityType,
                                            ...
                                            specific_asset_id: Optional[Set[base.SpecificAssetId]]):
