...
class CapabilityMetadata(Model):
    ...
    def __init__(self, extensions=None, category=None, id_short=None, display_name=None, description=None, model_type=None, embedded_data_specifications=None, semantic_id=None, supplemental_semantic_ids=None, qualifiers=None, kind=None):  # noqa: E501
        """CapabilityMetadata - a model defined in OpenAPI

        :param extensions: The extensions of this CapabilityMetadata.  # noqa: E501
        :type extensions: List[Extension]
        :param category: The category of this CapabilityMetadata.  # noqa: E501
        :type category: str
        :param id_short: The id_short of this CapabilityMetadata.  # noqa: E501
        :type id_short: object
        :param display_name: The display_name of this CapabilityMetadata.  # noqa: E501
        :type display_name: List[LangStringNameType]
        :param description: The description of this CapabilityMetadata.  # noqa: E501
        :type description: List[LangStringTextType]
        :param model_type: The model_type of this CapabilityMetadata.  # noqa: E501
        :type model_type: ModelType
        :param embedded_data_specifications: The embedded_data_specifications of this CapabilityMetadata.  # noqa: E501
        :type embedded_data_specifications: List[EmbeddedDataSpecification]
        :param semantic_id: The semantic_id of this CapabilityMetadata.  # noqa: E501
        :type semantic_id: Reference
        :param supplemental_semantic_ids: The supplemental_semantic_ids of this CapabilityMetadata.  # noqa: E501
        :type supplemental_semantic_ids: List[Reference]
        :param qualifiers: The qualifiers of this CapabilityMetadata.  # noqa: E501
        :type qualifiers: List[Qualifier]
        :param kind: The kind of this CapabilityMetadata.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CapabilityMetadata':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CapabilityMetadata of this CapabilityMetadata.  # noqa: E501
        :rtype: CapabilityMetadata
        """
        return util.deserialize_model(dikt, cls)

    @property
    def extensions(self) -> List[Extension]:
        """Gets the extensions of this CapabilityMetadata.


        :return: The extensions of this CapabilityMetadata.
    ...
    def extensions(self, extensions: List[Extension]):
        """Sets the extensions of this CapabilityMetadata.


        :param extensions: The extensions of this CapabilityMetadata.
        :type extensions: List[Extension]
        """
    ...
    def category(self) -> str:
        """Gets the category of this CapabilityMetadata.


        :return: The category of this CapabilityMetadata.
        :rtype: str
        """
    ...
    def category(self, category: str):
        """Sets the category of this CapabilityMetadata.


        :param category: The category of this CapabilityMetadata.
        :type category: str
        """
    ...
    def id_short(self) -> object:
        """Gets the id_short of this CapabilityMetadata.


        :return: The id_short of this CapabilityMetadata.
        :rtype: object
        """
    ...
    def id_short(self, id_short: object):
        """Sets the id_short of this CapabilityMetadata.


        :param id_short: The id_short of this CapabilityMetadata.
        :type id_short: object
        """
    ...
    def display_name(self) -> List[LangStringNameType]:
        """Gets the display_name of this CapabilityMetadata.


        :return: The display_name of this CapabilityMetadata.
    ...
    def display_name(self, display_name: List[LangStringNameType]):
        """Sets the display_name of this CapabilityMetadata.


        :param display_name: The display_name of this CapabilityMetadata.
        :type display_name: List[LangStringNameType]
        """
    ...
    def description(self) -> List[LangStringTextType]:
        """Gets the description of this CapabilityMetadata.


        :return: The description of this CapabilityMetadata.
    ...
    def description(self, description: List[LangStringTextType]):
        """Sets the description of this CapabilityMetadata.


        :param description: The description of this CapabilityMetadata.
        :type description: List[LangStringTextType]
        """
    ...
    def model_type(self) -> ModelType:
        """Gets the model_type of this CapabilityMetadata.


        :return: The model_type of this CapabilityMetadata.
        :rtype: ModelType
        """
    ...
    def model_type(self, model_type: ModelType):
        """Sets the model_type of this CapabilityMetadata.


        :param model_type: The model_type of this CapabilityMetadata.
        :type model_type: ModelType
        """
    ...
    def embedded_data_specifications(self) -> List[EmbeddedDataSpecification]:
        """Gets the embedded_data_specifications of this CapabilityMetadata.


        :return: The embedded_data_specifications of this CapabilityMetadata.
    ...
    def embedded_data_specifications(self, embedded_data_specifications: List[EmbeddedDataSpecification]):
        """Sets the embedded_data_specifications of this CapabilityMetadata.


        :param embedded_data_specifications: The embedded_data_specifications of this CapabilityMetadata.
        :type embedded_data_specifications: List[EmbeddedDataSpecification]
        """
    ...
    def semantic_id(self) -> Reference:
        """Gets the semantic_id of this CapabilityMetadata.


        :return: The semantic_id of this CapabilityMetadata.
        :rtype: Reference
        """
    ...
    def semantic_id(self, semantic_id: Reference):
        """Sets the semantic_id of this CapabilityMetadata.


        :param semantic_id: The semantic_id of this CapabilityMetadata.
        :type semantic_id: Reference
        """
    ...
    def supplemental_semantic_ids(self) -> List[Reference]:
        """Gets the supplemental_semantic_ids of this CapabilityMetadata.


        :return: The supplemental_semantic_ids of this CapabilityMetadata.
    ...
    def supplemental_semantic_ids(self, supplemental_semantic_ids: List[Reference]):
        """Sets the supplemental_semantic_ids of this CapabilityMetadata.


        :param supplemental_semantic_ids: The supplemental_semantic_ids of this CapabilityMetadata.
        :type supplemental_semantic_ids: List[Reference]
        """
    ...
    def qualifiers(self) -> List[Qualifier]:
        """Gets the qualifiers of this CapabilityMetadata.


        :return: The qualifiers of this CapabilityMetadata.
    ...
    def qualifiers(self, qualifiers: List[Qualifier]):
        """Sets the qualifiers of this CapabilityMetadata.


        :param qualifiers: The qualifiers of this CapabilityMetadata.
        :type qualifiers: List[Qualifier]
        """
    ...
    def kind(self) -> ModellingKind:
        """Gets the kind of this CapabilityMetadata.


        :return: The kind of this CapabilityMetadata.
        :rtype: ModellingKind
        """
        return self._kind
    ...
    def kind(self, kind: ModellingKind):
        """Sets the kind of this CapabilityMetadata.


        :param kind: The kind of this CapabilityMetadata.
        :type kind: ModellingKind
        """
