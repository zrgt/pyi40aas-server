...
class SubmodelElementMetadata(Model):
    ...
    def __init__(self, extensions=None, category=None, id_short=None, display_name=None, description=None, model_type=None, embedded_data_specifications=None, semantic_id=None, supplemental_semantic_ids=None, qualifiers=None, kind=None):  # noqa: E501
        """SubmodelElementMetadata - a model defined in OpenAPI

        :param extensions: The extensions of this SubmodelElementMetadata.  # noqa: E501
        :type extensions: List[Extension]
        :param category: The category of this SubmodelElementMetadata.  # noqa: E501
        :type category: str
        :param id_short: The id_short of this SubmodelElementMetadata.  # noqa: E501
        :type id_short: object
        :param display_name: The display_name of this SubmodelElementMetadata.  # noqa: E501
        :type display_name: List[LangStringNameType]
        :param description: The description of this SubmodelElementMetadata.  # noqa: E501
        :type description: List[LangStringTextType]
        :param model_type: The model_type of this SubmodelElementMetadata.  # noqa: E501
        :type model_type: ModelType
        :param embedded_data_specifications: The embedded_data_specifications of this SubmodelElementMetadata.  # noqa: E501
        :type embedded_data_specifications: List[EmbeddedDataSpecification]
        :param semantic_id: The semantic_id of this SubmodelElementMetadata.  # noqa: E501
        :type semantic_id: Reference
        :param supplemental_semantic_ids: The supplemental_semantic_ids of this SubmodelElementMetadata.  # noqa: E501
        :type supplemental_semantic_ids: List[Reference]
        :param qualifiers: The qualifiers of this SubmodelElementMetadata.  # noqa: E501
        :type qualifiers: List[Qualifier]
        :param kind: The kind of this SubmodelElementMetadata.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'SubmodelElementMetadata':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The SubmodelElementMetadata of this SubmodelElementMetadata.  # noqa: E501
        :rtype: SubmodelElementMetadata
        """
        return util.deserialize_model(dikt, cls)

    @property
    def extensions(self) -> List[Extension]:
        """Gets the extensions of this SubmodelElementMetadata.


        :return: The extensions of this SubmodelElementMetadata.
    ...
    def extensions(self, extensions: List[Extension]):
        """Sets the extensions of this SubmodelElementMetadata.


        :param extensions: The extensions of this SubmodelElementMetadata.
        :type extensions: List[Extension]
        """
    ...
    def category(self) -> str:
        """Gets the category of this SubmodelElementMetadata.


        :return: The category of this SubmodelElementMetadata.
        :rtype: str
        """
    ...
    def category(self, category: str):
        """Sets the category of this SubmodelElementMetadata.


        :param category: The category of this SubmodelElementMetadata.
        :type category: str
        """
    ...
    def id_short(self) -> object:
        """Gets the id_short of this SubmodelElementMetadata.


        :return: The id_short of this SubmodelElementMetadata.
        :rtype: object
        """
    ...
    def id_short(self, id_short: object):
        """Sets the id_short of this SubmodelElementMetadata.


        :param id_short: The id_short of this SubmodelElementMetadata.
        :type id_short: object
        """
    ...
    def display_name(self) -> List[LangStringNameType]:
        """Gets the display_name of this SubmodelElementMetadata.


        :return: The display_name of this SubmodelElementMetadata.
    ...
    def display_name(self, display_name: List[LangStringNameType]):
        """Sets the display_name of this SubmodelElementMetadata.


        :param display_name: The display_name of this SubmodelElementMetadata.
        :type display_name: List[LangStringNameType]
        """
    ...
    def description(self) -> List[LangStringTextType]:
        """Gets the description of this SubmodelElementMetadata.


        :return: The description of this SubmodelElementMetadata.
    ...
    def description(self, description: List[LangStringTextType]):
        """Sets the description of this SubmodelElementMetadata.


        :param description: The description of this SubmodelElementMetadata.
        :type description: List[LangStringTextType]
        """
    ...
    def model_type(self) -> ModelType:
        """Gets the model_type of this SubmodelElementMetadata.


        :return: The model_type of this SubmodelElementMetadata.
        :rtype: ModelType
        """
    ...
    def model_type(self, model_type: ModelType):
        """Sets the model_type of this SubmodelElementMetadata.


        :param model_type: The model_type of this SubmodelElementMetadata.
        :type model_type: ModelType
        """
    ...
    def embedded_data_specifications(self) -> List[EmbeddedDataSpecification]:
        """Gets the embedded_data_specifications of this SubmodelElementMetadata.


        :return: The embedded_data_specifications of this SubmodelElementMetadata.
    ...
    def embedded_data_specifications(self, embedded_data_specifications: List[EmbeddedDataSpecification]):
        """Sets the embedded_data_specifications of this SubmodelElementMetadata.


        :param embedded_data_specifications: The embedded_data_specifications of this SubmodelElementMetadata.
        :type embedded_data_specifications: List[EmbeddedDataSpecification]
        """
    ...
    def semantic_id(self) -> Reference:
        """Gets the semantic_id of this SubmodelElementMetadata.


        :return: The semantic_id of this SubmodelElementMetadata.
        :rtype: Reference
        """
    ...
    def semantic_id(self, semantic_id: Reference):
        """Sets the semantic_id of this SubmodelElementMetadata.


        :param semantic_id: The semantic_id of this SubmodelElementMetadata.
        :type semantic_id: Reference
        """
    ...
    def supplemental_semantic_ids(self) -> List[Reference]:
        """Gets the supplemental_semantic_ids of this SubmodelElementMetadata.


        :return: The supplemental_semantic_ids of this SubmodelElementMetadata.
    ...
    def supplemental_semantic_ids(self, supplemental_semantic_ids: List[Reference]):
        """Sets the supplemental_semantic_ids of this SubmodelElementMetadata.


        :param supplemental_semantic_ids: The supplemental_semantic_ids of this SubmodelElementMetadata.
        :type supplemental_semantic_ids: List[Reference]
        """
    ...
    def qualifiers(self) -> List[Qualifier]:
        """Gets the qualifiers of this SubmodelElementMetadata.


        :return: The qualifiers of this SubmodelElementMetadata.
    ...
    def qualifiers(self, qualifiers: List[Qualifier]):
        """Sets the qualifiers of this SubmodelElementMetadata.


        :param qualifiers: The qualifiers of this SubmodelElementMetadata.
        :type qualifiers: List[Qualifier]
        """
    ...
    def kind(self) -> ModellingKind:
        """Gets the kind of this SubmodelElementMetadata.


        :return: The kind of this SubmodelElementMetadata.
        :rtype: ModellingKind
        """
        return self._kind
    ...
    def kind(self, kind: ModellingKind):
        """Sets the kind of this SubmodelElementMetadata.


        :param kind: The kind of this SubmodelElementMetadata.
        :type kind: ModellingKind
        """
