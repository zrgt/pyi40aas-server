...
class FileMetadata(Model):
    ...
    def __init__(self, extensions=None, category=None, id_short=None, display_name=None, description=None, model_type=None, embedded_data_specifications=None, semantic_id=None, supplemental_semantic_ids=None, qualifiers=None, kind=None):  # noqa: E501
        ...
        :param extensions: The extensions of this FileMetadata.  # noqa: E501
        :type extensions: List[Extension]
        :param category: The category of this FileMetadata.  # noqa: E501
        :type category: str
        :param id_short: The id_short of this FileMetadata.  # noqa: E501
        :type id_short: object
        :param display_name: The display_name of this FileMetadata.  # noqa: E501
        :type display_name: List[LangStringNameType]
        :param description: The description of this FileMetadata.  # noqa: E501
        :type description: List[LangStringTextType]
        :param model_type: The model_type of this FileMetadata.  # noqa: E501
        :type model_type: ModelType
        :param embedded_data_specifications: The embedded_data_specifications of this FileMetadata.  # noqa: E501
        :type embedded_data_specifications: List[EmbeddedDataSpecification]
        :param semantic_id: The semantic_id of this FileMetadata.  # noqa: E501
        :type semantic_id: Reference
        :param supplemental_semantic_ids: The supplemental_semantic_ids of this FileMetadata.  # noqa: E501
        :type supplemental_semantic_ids: List[Reference]
        :param qualifiers: The qualifiers of this FileMetadata.  # noqa: E501
    ...
    def extensions(self) -> List[Extension]:
        """Gets the extensions of this FileMetadata.


        :return: The extensions of this FileMetadata.
    ...
    def extensions(self, extensions: List[Extension]):
        """Sets the extensions of this FileMetadata.


        :param extensions: The extensions of this FileMetadata.
        :type extensions: List[Extension]
        """
    ...
    def category(self) -> str:
        """Gets the category of this FileMetadata.


        :return: The category of this FileMetadata.
        :rtype: str
        """
    ...
    def category(self, category: str):
        """Sets the category of this FileMetadata.


        :param category: The category of this FileMetadata.
        :type category: str
        """
    ...
    def id_short(self) -> object:
        """Gets the id_short of this FileMetadata.


        :return: The id_short of this FileMetadata.
        :rtype: object
        """
    ...
    def id_short(self, id_short: object):
        """Sets the id_short of this FileMetadata.


        :param id_short: The id_short of this FileMetadata.
        :type id_short: object
        """
    ...
    def display_name(self) -> List[LangStringNameType]:
        """Gets the display_name of this FileMetadata.


        :return: The display_name of this FileMetadata.
    ...
    def display_name(self, display_name: List[LangStringNameType]):
        """Sets the display_name of this FileMetadata.


        :param display_name: The display_name of this FileMetadata.
        :type display_name: List[LangStringNameType]
        """
    ...
    def description(self) -> List[LangStringTextType]:
        """Gets the description of this FileMetadata.


        :return: The description of this FileMetadata.
    ...
    def description(self, description: List[LangStringTextType]):
        """Sets the description of this FileMetadata.


        :param description: The description of this FileMetadata.
        :type description: List[LangStringTextType]
        """
    ...
    def model_type(self) -> ModelType:
        """Gets the model_type of this FileMetadata.


        :return: The model_type of this FileMetadata.
        :rtype: ModelType
        """
    ...
    def model_type(self, model_type: ModelType):
        """Sets the model_type of this FileMetadata.


        :param model_type: The model_type of this FileMetadata.
        :type model_type: ModelType
        """
    ...
    def embedded_data_specifications(self) -> List[EmbeddedDataSpecification]:
        """Gets the embedded_data_specifications of this FileMetadata.


        :return: The embedded_data_specifications of this FileMetadata.
    ...
    def embedded_data_specifications(self, embedded_data_specifications: List[EmbeddedDataSpecification]):
        """Sets the embedded_data_specifications of this FileMetadata.


        :param embedded_data_specifications: The embedded_data_specifications of this FileMetadata.
        :type embedded_data_specifications: List[EmbeddedDataSpecification]
        """
    ...
    def semantic_id(self) -> Reference:
        """Gets the semantic_id of this FileMetadata.


        :return: The semantic_id of this FileMetadata.
        :rtype: Reference
        """
    ...
    def semantic_id(self, semantic_id: Reference):
        """Sets the semantic_id of this FileMetadata.


        :param semantic_id: The semantic_id of this FileMetadata.
        :type semantic_id: Reference
        """
    ...
    def supplemental_semantic_ids(self) -> List[Reference]:
        """Gets the supplemental_semantic_ids of this FileMetadata.


        :return: The supplemental_semantic_ids of this FileMetadata.
    ...
    def supplemental_semantic_ids(self, supplemental_semantic_ids: List[Reference]):
        """Sets the supplemental_semantic_ids of this FileMetadata.


        :param supplemental_semantic_ids: The supplemental_semantic_ids of this FileMetadata.
        :type supplemental_semantic_ids: List[Reference]
        """
    ...
    def qualifiers(self) -> List[Qualifier]:
        """Gets the qualifiers of this FileMetadata.


        :return: The qualifiers of this FileMetadata.
    ...
    def qualifiers(self, qualifiers: List[Qualifier]):
        """Sets the qualifiers of this FileMetadata.


        :param qualifiers: The qualifiers of this FileMetadata.
        :type qualifiers: List[Qualifier]
        """
    ...
    def kind(self) -> ModellingKind:
        """Gets the kind of this FileMetadata.


        :return: The kind of this FileMetadata.
        :rtype: ModellingKind
        """
        return self._kind
    ...
    def kind(self, kind: ModellingKind):
        ...
        :param kind: The kind of this FileMetadata.
        :type kind: ModellingKind
        """
